      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {/* Strength 1 */}
            <div className="bg-white p-8 rounded-lg shadow-lg border-2 border-primary-100 hover:border-primary-300 transition">
          ...
          <div className="max-w-5xl mx-auto space-y-8">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="md:flex">
                ...
                <div className="md:w-2/3 p-8">
                  <h4 className="text-xl font-bold mb-4 text-gray-900">三菱系FA機器の設置・配線・メンテナンス</h4>
                  <p className="text-gray-600 mb-4">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="md:flex md:flex-row-reverse">
                ...
                <div className="md:w-2/3 p-8">
                  <h4 className="text-xl font-bold mb-4 text-gray-900">工作機械の電気設備工事</h4>
                  <p className="text-gray-600 mb-4">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="md:flex">
                ...
                <div className="md:w-2/3 p-8">
                  <h4 className="text-xl font-bold mb-4 text-gray-900">カスタム制御盤の設計・製作</h4>
                  <p className="text-gray-600 mb-4">
                    <span className="coming-soon-badge mb-2 inline-block">Coming soon</span>
                  </p>
                  <div className="placeholder-section">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="md:flex md:flex-row-reverse">
                ...
                <div className="md:w-2/3 p-8">
                  <h4 className="text-xl font-bold mb-4 text-gray-900">定期メンテナンス・緊急対応</h4>
                  <p className="text-gray-600 mb-4">
                    <span className="coming-soon-badge mb-2 inline-block">Coming soon</span>
                  </p>
                  <div className="placeholder-section">
